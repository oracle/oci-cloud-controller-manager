...
// request_requirements.go embedded. Added returnRespBodyAsStream
// to indicate if response returns a body of io.ReadCloser instead of
// the default []byte type.
...
func (r *requestDetails) marshalBody() (marshaled interface{}, e error) {
...
func (r *requestDetails) marshalReturnRespBodyAsStream() bool {
	return r.returnRespBodyAsStream
}