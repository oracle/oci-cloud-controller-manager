...
// UpdateBatchInstanceDetails Details for updating a batch instance.
type UpdateBatchInstanceDetails struct {

	// The name of the batch instance must consist of lower case alphanumeric characters or ‘-’,
	// start with an alphabetic character, and end with an alphanumeric character,
	// (e.g.’my-name’ or ‘abc-123’ or 'batchname')
...
func (m UpdateBatchInstanceDetails) String() string {
