...
// ComputeEnvironmentSummary Condensed ComputeEnvironment data when listing compute environments.
type ComputeEnvironmentSummary struct {
	...
	LifecycleState ComputeEnvironmentSummaryLifecycleStateEnum `mandatory:"false" json:"lifecycleState,omitempty"`
...
func (m ComputeEnvironmentSummary) String() string {
	return common.PointerString(m)
}

// ComputeEnvironmentSummaryLifecycleStateEnum Enum with underlying type: string
type ComputeEnvironmentSummaryLifecycleStateEnum string

// Set of constants representing the allowable values for ComputeEnvironmentSummaryLifecycleStateEnum
const (
	ComputeEnvironmentSummaryLifecycleStateActive    ComputeEnvironmentSummaryLifecycleStateEnum = "ACTIVE"
	ComputeEnvironmentSummaryLifecycleStateDisabling ComputeEnvironmentSummaryLifecycleStateEnum = "DISABLING"
	ComputeEnvironmentSummaryLifecycleStateInactive  ComputeEnvironmentSummaryLifecycleStateEnum = "INACTIVE"
	ComputeEnvironmentSummaryLifecycleStateDeleted   ComputeEnvironmentSummaryLifecycleStateEnum = "DELETED"
)

var mappingComputeEnvironmentSummaryLifecycleState = map[string]ComputeEnvironmentSummaryLifecycleStateEnum{
	"ACTIVE":    ComputeEnvironmentSummaryLifecycleStateActive,
	"DISABLING": ComputeEnvironmentSummaryLifecycleStateDisabling,
	"INACTIVE":  ComputeEnvironmentSummaryLifecycleStateInactive,
	"DELETED":   ComputeEnvironmentSummaryLifecycleStateDeleted,
}

// GetComputeEnvironmentSummaryLifecycleStateEnumValues Enumerates the set of values for ComputeEnvironmentSummaryLifecycleStateEnum
func GetComputeEnvironmentSummaryLifecycleStateEnumValues() []ComputeEnvironmentSummaryLifecycleStateEnum {
	values := make([]ComputeEnvironmentSummaryLifecycleStateEnum, 0)
	for _, v := range mappingComputeEnvironmentSummaryLifecycleState {
