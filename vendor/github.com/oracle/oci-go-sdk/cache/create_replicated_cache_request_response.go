...
func (request CreateReplicatedCacheRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateReplicatedCacheRequest) HTTPRequest(method, path string) (http.Request, error) {
	return common.MakeDefaultHTTPRequestWithTaggedStruct(method, path, request)
}

// RetryPolicy implements the OCIRetryableRequest interface. This retrieves the specified retry policy.
func (request CreateReplicatedCacheRequest) RetryPolicy() *common.RetryPolicy {
	return request.RequestMetadata.RetryPolicy
}

// CreateReplicatedCacheResponse wrapper for the CreateReplicatedCache operation
type CreateReplicatedCacheResponse struct {
...
func (response CreateReplicatedCacheResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateReplicatedCacheResponse) HTTPResponse() *http.Response {
