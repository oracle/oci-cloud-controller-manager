...
func printInstanceInfo(id string, c core.ComputeClient, availabilityDomain string) {
	compartmentId = id
	log.Printf("   Compartment Id : %s", compartmentId)
	printVolumeAttachments(c)
	printVnicAttachments(c)
	printBootVolumecAttachments(c, availabilityDomain)
	printConsoleConnections(c)
	printConsoleHistories(c)

}

func printVolumeAttachments(c core.ComputeClient) {
...
func printVnicAttachments(c core.ComputeClient) {
...
func printBootVolumecAttachments(c core.ComputeClient, availabilityDomain string) {
...
func printConsoleConnections(c core.ComputeClient) {
...
func printConsoleHistories(c core.ComputeClient) {
