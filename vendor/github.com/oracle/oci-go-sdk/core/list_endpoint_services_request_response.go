...
func (request ListEndpointServicesRequest) HTTPRequest(method, path string) (http.Request, error) {
...
var mappingListEndpointServicesSortBy = map[string]ListEndpointServicesSortByEnum{
...
func GetListEndpointServicesSortByEnumValues() []ListEndpointServicesSortByEnum {
	...
	for _, v := range mappingListEndpointServicesSortBy {
...
var mappingListEndpointServicesSortOrder = map[string]ListEndpointServicesSortOrderEnum{
...
func GetListEndpointServicesSortOrderEnumValues() []ListEndpointServicesSortOrderEnum {
	...
	for _, v := range mappingListEndpointServicesSortOrder {
		values = append(values, v)
	}
	return values
}
