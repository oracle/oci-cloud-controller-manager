...
type ChangeReplicationCompartmentDetails struct {
	...
	// The OCID (https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the compartment to move the replication to. This will also change the replication target's compartment in target region.
