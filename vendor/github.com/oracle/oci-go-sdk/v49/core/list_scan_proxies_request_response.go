...
var mappingListScanProxiesSortBy = map[string]ListScanProxiesSortByEnum{
...
func GetListScanProxiesSortByEnumValues() []ListScanProxiesSortByEnum {
	...
	for _, v := range mappingListScanProxiesSortBy {
...
var mappingListScanProxiesSortOrder = map[string]ListScanProxiesSortOrderEnum{
...
func GetListScanProxiesSortOrderEnumValues() []ListScanProxiesSortOrderEnum {
	...
	for _, v := range mappingListScanProxiesSortOrder {
		values = append(values, v)
	}
	return values
}
