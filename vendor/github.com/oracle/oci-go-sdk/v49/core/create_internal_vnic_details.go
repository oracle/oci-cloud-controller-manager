...
var mappingCreateInternalVnicDetailsServiceVnicType = map[string]CreateInternalVnicDetailsServiceVnicTypeEnum{
...
func GetCreateInternalVnicDetailsServiceVnicTypeEnumValues() []CreateInternalVnicDetailsServiceVnicTypeEnum {
	...
	for _, v := range mappingCreateInternalVnicDetailsServiceVnicType {
		values = append(values, v)
	}
	return values
}
