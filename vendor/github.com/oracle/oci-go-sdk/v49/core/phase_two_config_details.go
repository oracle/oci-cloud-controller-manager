...
type PhaseTwoConfigDetails struct {
	...
	// Supported Phase two authentication algorithms supported during tunnel negotiation.
	...
	// Supported Phase two encryption algorithms supported during tunnel negotiation.
