...
// ComputeCluster A compute cluster.
type ComputeCluster struct {
	...
	// The OCID of the compartment having this compute cluster.
...
var mappingComputeClusterLifecycleState = map[string]ComputeClusterLifecycleStateEnum{
...
func GetComputeClusterLifecycleStateEnumValues() []ComputeClusterLifecycleStateEnum {
	...
	for _, v := range mappingComputeClusterLifecycleState {
