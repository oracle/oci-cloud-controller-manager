...
var mappingCreateClientVpnDetailsAddressingMode = map[string]CreateClientVpnDetailsAddressingModeEnum{
...
func GetCreateClientVpnDetailsAddressingModeEnumValues() []CreateClientVpnDetailsAddressingModeEnum {
	...
	for _, v := range mappingCreateClientVpnDetailsAddressingMode {
...
var mappingCreateClientVpnDetailsAuthenticationMode = map[string]CreateClientVpnDetailsAuthenticationModeEnum{
...
func GetCreateClientVpnDetailsAuthenticationModeEnumValues() []CreateClientVpnDetailsAuthenticationModeEnum {
	...
	for _, v := range mappingCreateClientVpnDetailsAuthenticationMode {
		values = append(values, v)
	}
	return values
}
