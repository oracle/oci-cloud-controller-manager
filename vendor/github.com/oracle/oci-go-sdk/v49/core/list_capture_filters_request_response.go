...
func GetListCaptureFiltersSortByEnumValues() []ListCaptureFiltersSortByEnum {
	...
	for _, v := range mappingListCaptureFiltersSortBy {
...
var mappingListCaptureFiltersSortOrder = map[string]ListCaptureFiltersSortOrderEnum{
...
func GetListCaptureFiltersSortOrderEnumValues() []ListCaptureFiltersSortOrderEnum {
	...
	for _, v := range mappingListCaptureFiltersSortOrder {
		values = append(values, v)
	}
	return values
}
