...
// TunnelPhaseOneDetails Tunnel Detail Information specific to IKE Phase 1
type TunnelPhaseOneDetails struct {
	...
	// List of proposed Authentication Algorithms
	...
	// List of proposed DH Groups
	ProposedDhGroups []string `mandatory:"false" json:"proposedDhGroups"`
