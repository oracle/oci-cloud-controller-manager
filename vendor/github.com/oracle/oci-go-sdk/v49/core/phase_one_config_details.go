...
type PhaseOneConfigDetails struct {
	...
	// Supported Phase one authentication algorithms supported during tunnel negotiation.
...
const (
	PhaseOneConfigDetailsDiffieHelmanGroupGroup1  PhaseOneConfigDetailsDiffieHelmanGroupEnum = "GROUP1"
...
var mappingPhaseOneConfigDetailsDiffieHelmanGroup = map[string]PhaseOneConfigDetailsDiffieHelmanGroupEnum{
	"GROUP1":  PhaseOneConfigDetailsDiffieHelmanGroupGroup1,
