...
var mappingListVtapsSortBy = map[string]ListVtapsSortByEnum{
...
func GetListVtapsSortByEnumValues() []ListVtapsSortByEnum {
	...
	for _, v := range mappingListVtapsSortBy {
...
var mappingListVtapsSortOrder = map[string]ListVtapsSortOrderEnum{
...
func GetListVtapsSortOrderEnumValues() []ListVtapsSortOrderEnum {
	...
	for _, v := range mappingListVtapsSortOrder {
		values = append(values, v)
	}
	return values
}
