...
// SubnetTopology Defines the representation of a Subnet topology for a VCN.
type SubnetTopology struct {
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Subnet for which the topology is generated.
