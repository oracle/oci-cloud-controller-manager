...
| `service.beta.kubernetes.io/oci-load-balancer-backend-protocol`                 | Specifies protocol on which the listener accepts connection requests. Available Protocols are `TCP`, `HTTP` and `HTTP2`.To get a list of valid protocols, use the [`ListProtocols`][5] operation.                                                                                                                                  | `"TCP"`                                          |
...
| `oci.oraclecloud.com/initial-defined-tags-override`                             | Specifies one or more Defined tags to apply to the OCI Load Balancer. Valid values: `'{"namespace1": {"tag1": "value1", "tag2": "value2"}}'`                                                                                                                                                     | `N/A`                                            |
| `oci.oraclecloud.com/initial-freeform-tags-override`                            | Specifies one or more Freeform tags to apply to the OCI Load Balancer. Valid values: '{"tag1": "value1", "tag2": "value2"}'`                                                                                                                                                     | `N/A`                                            |
