...
| `oci-load-balancer-subnets`                 | The OCID of the [subnet][2] required to attach the load balancer to.                                                                                                                                                                               | Value provided in config file                                      |
| `oci-load-balancer-subnet1`                 | [Deprecated] The OCID of the first [subnet][2] of the two required subnets to attach the load balancer to. Must be in separate Availability Domains.                                                                                                            | Value provided in config file                    |
| `oci-load-balancer-subnet2`                 | [Deprecated] The OCID of the second [subnet][2] of the two required subnets to attach the load balancer to. Must be in separate Availability Domains.                                                                                                           | Value provided in config file                    |
