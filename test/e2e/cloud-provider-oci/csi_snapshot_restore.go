...
func checkOrInstallCRDs(f *framework.CloudProviderFramework) {
	...
	if err != nil {
		if setupF.EnableCreateCluster == false {
			...
			framework.RunKubectl("create", "-f", "https://raw.githubusercontent.com/kubernetes-csi/external-snapshotter/v6.0.1/client/config/crd/snapshot.storage.k8s.io_volumesnapshots.yaml")
		}
	}
	...
	if err != nil {
		if setupF.EnableCreateCluster == false {
			...
			framework.RunKubectl("create", "-f", "https://raw.githubusercontent.com/kubernetes-csi/external-snapshotter/v6.0.1/client/config/crd/snapshot.storage.k8s.io_volumesnapshotclasses.yaml")
		}
	}
	...
	if err != nil {
		if setupF.EnableCreateCluster == false {
			...
			framework.RunKubectl("create", "-f", "https://raw.githubusercontent.com/kubernetes-csi/external-snapshotter/v6.0.1/client/config/crd/snapshot.storage.k8s.io_volumesnapshotcontents.yaml")
		}
	}
}
