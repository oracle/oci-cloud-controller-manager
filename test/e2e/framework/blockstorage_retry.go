...
func blockStorageDeleteRequestMetadata() common.RequestMetadata {
	// Cleanup should tolerate transient service and network failures without retrying indefinitely.
