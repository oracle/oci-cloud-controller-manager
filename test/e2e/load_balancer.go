...
// 			s.Spec.Type = v1.ServiceTypeLoadBalancer
// 			s.Spec.LoadBalancerIP = requestedIP                                                                                                 // will be "" if not applicable
// 			s.ObjectMeta.Annotations = map[string]string{cloudprovider.ServiceAnnotationLoadBalancerTLSBackendSecret: "ssl-certificate-secret"} // cloudprovider.ServiceAnnotationLoadBalancerTLSSecret: "ssl-certificate-secret",
